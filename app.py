...
# ========== FORCE CONFIG ==========
FORCE_REGION = "ID"
FORCE_PASS_PREFIX = "ZYXX-HAX"
FORCE_NAME_PREFIX = "ZYXX"

# ========== OB55 CONFIG ==========
RELEASE_VERSION = "OB55"
UNITY_VERSION = "2018.4.12f1"
X_GA_SV = "1789535859"
CLIENT_VERSION = "2019118693"
HEADER_UA = "UnityPlayer/2018.4.12f1 (UnityWebRequest/1.0, libcurl/8.5.0-DEV)"
...
CHOOSE_REGION_URL = "https://loginbp.ppmainecoonghj.com/ChooseRegion"
...
REGION_LANG = {
    ...
    "EU": "en", "RU": "ru", "NA": "en", "SAC": "es", "BR": "pt"
}
...
def generate_custom_password(password_prefix="ZYXX"):
    prefix = password_prefix.upper() if password_prefix else "ZYXX"
    prefix = prefix[:5]
...
def create_acc(region, name_prefix, password_prefix="ZYXX"):
...
def home():
    return jsonify({
        "message": "ZYXX - Free Fire Account Generator OB55",
        "status": "active",
        "release_version": RELEASE_VERSION,
        "config": {
            "region": FORCE_REGION,
